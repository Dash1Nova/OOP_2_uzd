...
This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, add {\ttfamily \#include \texorpdfstring{$<$}{<}\doxylink{gmock_8h_source}{gmock/\+gmock.\+h}\texorpdfstring{$>$}{>}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_macros}{}\doxysubsection{\texorpdfstring{Macros}{Macros}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}{}\doxysubsubsection{\texorpdfstring{MOCK\+\_\+\+METHOD}{MOCK\+\_\+\+METHOD}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}
...
See details for each modifier clause below.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}{}\doxysubsubsubsection{\texorpdfstring{With \{\+\#\+EXPECT\+\_\+\+CALL.\+With\}}{With \{\+\#\+EXPECT\+\_\+\+CALL.\+With\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}{}\doxysubsubsubsection{\texorpdfstring{In\+Sequence \{\+\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}{In\+Sequence \{\+\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}
...
\DoxyCodeLine{EXPECT\_CALL(my\_mock,\ \doxymbox{\hyperlink{namespacetesting_1_1gmock__matchers__test_a738a538e1705ea49670aeb3ed25108e6}{Describe}}())}
...
See also the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}{\`{}\+In\+Sequence\`{} class}{2}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}{}\doxysubsubsubsection{\texorpdfstring{After \{\+\#\+EXPECT\+\_\+\+CALL.\+After\}}{After \{\+\#\+EXPECT\+\_\+\+CALL.\+After\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}{}\doxysubsubsubsection{\texorpdfstring{Will\+Once \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}{Will\+Once \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/\+or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md270}{}\doxysubsubsubsection{\texorpdfstring{Will\+Repeatedly \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}{Will\+Repeatedly \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md270}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ON_CALL}{}\doxysubsubsection{\texorpdfstring{ON\+\_\+\+CALL}{ON\+\_\+\+CALL}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ON_CALL}
...
See details for each modifier clause below.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md272}{}\doxysubsubsubsection{\texorpdfstring{With \{\+\#\+ON\+\_\+\+CALL.\+With\}}{With \{\+\#\+ON\+\_\+\+CALL.\+With\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md272}
{\ttfamily .With(}\texorpdfstring{$\ast$}{*}{\ttfamily multi\+\_\+argument\+\_\+matcher}\texorpdfstring{$\ast$}{*}{\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md273}{}\doxysubsubsubsection{\texorpdfstring{Will\+By\+Default \{\+\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}{Will\+By\+Default \{\+\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md273}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_classes}{}\doxysubsection{\texorpdfstring{Classes}{Classes}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}{}\doxysubsubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}{}\doxysubsubsection{\texorpdfstring{Nice\+Mock}{Nice\+Mock}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}{}\doxysubsubsection{\texorpdfstring{Naggy\+Mock}{Naggy\+Mock}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}
...
\doxylink{class_mock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}{}\doxysubsubsection{\texorpdfstring{Strict\+Mock}{Strict\+Mock}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}
...
{\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}{}\doxysubsubsection{\texorpdfstring{Sequence}{Sequence}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}
{\ttfamily ::\+testing::\+\+Sequence}

Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}{}\doxysubsubsection{\texorpdfstring{In\+Sequence}{In\+Sequence}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}{}\doxysubsubsection{\texorpdfstring{Expectation}{Expectation}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}{}\doxysubsubsection{\texorpdfstring{Expectation\+Set}{Expectation\+Set}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}
