...
\DoxyCodeLine{00089\ \textcolor{preprocessor}{\ \ GTEST\_API\_\ ABSL\_DECLARE\_FLAG(bool,\ GMOCK\_FLAG\_NAME\_(name))}}
\DoxyCodeLine{00090\ \textcolor{preprocessor}{\#define\ GMOCK\_DECLARE\_int32\_(name)\ \(\backslash\)}}
\DoxyCodeLine{00091\ \textcolor{preprocessor}{\ \ GTEST\_API\_\ ABSL\_DECLARE\_FLAG(int32\_t,\ GMOCK\_FLAG\_NAME\_(name))}}
\DoxyCodeLine{00092\ \textcolor{preprocessor}{\#define\ GMOCK\_DECLARE\_string\_(name)\ \(\backslash\)}}
\DoxyCodeLine{00093\ \textcolor{preprocessor}{\ \ GTEST\_API\_\ ABSL\_DECLARE\_FLAG(std::string,\ GMOCK\_FLAG\_NAME\_(name))}}
\DoxyCodeLine{00094\ }
