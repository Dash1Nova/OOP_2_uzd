\doxysubsection{gmock-\/internal-\/utils.cc}
...
\DoxyCodeLine{00059\ GTEST\_API\_\ std::string\ \doxymbox{\hyperlink{namespacetesting_1_1internal_ac75a9353286d1b50c872ea2b195f3b4a}{JoinAsKeyValueTuple}}(}
\DoxyCodeLine{00060\ \ \ \ \ \textcolor{keyword}{const}\ std::vector<const\ char*>\&\ names,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a0bc587b0c4e6a800cdff5c014b0fe90a}{Strings}}\&\ values)\ \{}
...
\DoxyCodeLine{00081\ GTEST\_API\_\ std::string\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a0b375abcf3081393e6c420194a541b29}{ConvertIdentifierNameToWords}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ id\_name)\ \{}
...
\DoxyCodeLine{00087\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ starts\_new\_word\ =\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a84f3baa379fec6bf5947cb5165aa8cc9}{IsUpper}}(*p)\ ||}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (!\doxymbox{\hyperlink{namespacetesting_1_1internal_aeb957087fd6bbf9db98ab7cd41b0c129}{IsAlpha}}(prev\_char)\ \&\&\ \doxymbox{\hyperlink{namespacetesting_1_1internal_ac26ce3883bc8919c27074975e958f3b7}{IsLower}}(*p))\ ||}
\DoxyCodeLine{00089\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (!\doxymbox{\hyperlink{namespacetesting_1_1internal_a4bd96b7fa6486802d33ddc217af55a39}{IsDigit}}(prev\_char)\ \&\&\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a4bd96b7fa6486802d33ddc217af55a39}{IsDigit}}(*p));}
\DoxyCodeLine{00090\ }
\DoxyCodeLine{00091\ \ \ \ \ \textcolor{keywordflow}{if}\ (\doxymbox{\hyperlink{namespacetesting_1_1internal_a83802e7f23324cd512232203662e1a98}{IsAlNum}}(*p))\ \{}
\DoxyCodeLine{00092\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (starts\_new\_word\ \&\&\ !result.empty())\ result\ +=\ \textcolor{charliteral}{'\ '};}
\DoxyCodeLine{00093\ \ \ \ \ \ \ result\ +=\ \doxymbox{\hyperlink{namespacetesting_1_1internal_ad9c627ef2a94245e3fd69e7ab3d49b42}{ToLower}}(*p);}
\DoxyCodeLine{00094\ \ \ \ \ \}}
\DoxyCodeLine{00095\ \ \ \}}
...
\DoxyCodeLine{00102\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_google_test_failure_reporter}{GoogleTestFailureReporter}}\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface}{FailureReporterInterface}}\ \{}
...
\DoxyCodeLine{00106\ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_assert_helper}{AssertHelper}}(type\ ==\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface_aba34db997df0aefbfdc9d199d7d2ab5ea39560d6222d07508d8ef9f0ea6b030dd}{kFatal}}\ ?\ TestPartResult::kFatalFailure}
\DoxyCodeLine{00107\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ TestPartResult::kNonFatalFailure,}
\DoxyCodeLine{00108\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ file,\ line,\ message.c\_str())\ =\ \doxymbox{\hyperlink{classtesting_1_1_message}{Message}}();}
\DoxyCodeLine{00109\ \ \ \ \ \textcolor{keywordflow}{if}\ (type\ ==\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface_aba34db997df0aefbfdc9d199d7d2ab5ea39560d6222d07508d8ef9f0ea6b030dd}{kFatal}})\ \{}
\DoxyCodeLine{00110\ \ \ \ \ \ \ \doxymbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a69b8278c59359dd6a6f941b4643db9fb}{posix::Abort}}();}
\DoxyCodeLine{00111\ \ \ \ \ \}}
\DoxyCodeLine{00112\ \ \ \}}
\DoxyCodeLine{00113\ \};}
\DoxyCodeLine{00114\ }
...
\DoxyCodeLine{00117\ GTEST\_API\_\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface}{FailureReporterInterface}}*\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a93a00bf550dcc6b1de870d24c624869c}{GetFailureReporter}}()\ \{}
...
\DoxyCodeLine{00123\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface}{FailureReporterInterface}}*\ \textcolor{keyword}{const}\ failure\_reporter\ =}
\DoxyCodeLine{00124\ \ \ \ \ \ \ \textcolor{keyword}{new}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_google_test_failure_reporter}{GoogleTestFailureReporter}}();}
...
\DoxyCodeLine{00133\ GTEST\_API\_\ \textcolor{keywordtype}{bool}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a69ffdba5ee36743e88d8f89b79e566ff}{LogIsVisible}}(\doxymbox{\hyperlink{namespacetesting_1_1internal_a203d1a8a2147a53d12bbdae40d443914}{LogSeverity}}\ severity)\ \{}
\DoxyCodeLine{00134\ \ \ \textcolor{keywordflow}{if}\ (GMOCK\_FLAG\_GET(verbose)\ ==\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a96274a788ffc75a6dffdfa8aa1f34fb9}{kInfoVerbosity}})\ \{}
...
\DoxyCodeLine{00137\ \ \ \}\ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (GMOCK\_FLAG\_GET(verbose)\ ==\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a3d730761274e7b80dd66e5014171fcb5}{kErrorVerbosity}})\ \{}
...
\DoxyCodeLine{00143\ \ \ \ \ \textcolor{keywordflow}{return}\ severity\ ==\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a203d1a8a2147a53d12bbdae40d443914a5beeeab1b0a3caabd0afb43356c1a271}{kWarning}};}
\DoxyCodeLine{00144\ \ \ \}}
\DoxyCodeLine{00145\ \}}
\DoxyCodeLine{00146\ }
...
\DoxyCodeLine{00154\ GTEST\_API\_\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a8a57ce0412334a3f487bbaa8321febbe}{Log}}(\doxymbox{\hyperlink{namespacetesting_1_1internal_a203d1a8a2147a53d12bbdae40d443914}{LogSeverity}}\ severity,\ \textcolor{keyword}{const}\ std::string\&\ message,}
\DoxyCodeLine{00155\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ stack\_frames\_to\_skip)\ \{}
\DoxyCodeLine{00156\ \ \ \textcolor{keywordflow}{if}\ (!\doxymbox{\hyperlink{namespacetesting_1_1internal_a69ffdba5ee36743e88d8f89b79e566ff}{LogIsVisible}}(severity))\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00157\ }
\DoxyCodeLine{00158\ \ \ \textcolor{comment}{//\ Ensures\ that\ logs\ from\ different\ threads\ don't\ interleave.}}
\DoxyCodeLine{00159\ \ \ \doxymbox{\hyperlink{namespacetesting_1_1internal_a08b187c6cc4e28400aadf9a32fccc8de}{MutexLock}}\ l(g\_log\_mutex);}
\DoxyCodeLine{00160\ }
\DoxyCodeLine{00161\ \ \ \textcolor{keywordflow}{if}\ (severity\ ==\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a203d1a8a2147a53d12bbdae40d443914a5beeeab1b0a3caabd0afb43356c1a271}{kWarning}})\ \{}
...
\DoxyCodeLine{00185\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ <<\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a4b234f8922078deba93158cdbe956bf4}{::testing::internal::GetCurrentOsStackTraceExceptTop}}(}
\DoxyCodeLine{00186\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ actual\_to\_skip);}
\DoxyCodeLine{00187\ \ \ \}}
\DoxyCodeLine{00188\ \ \ std::cout\ <<\ ::std::flush;}
\DoxyCodeLine{00189\ \}}
\DoxyCodeLine{00190\ }
\DoxyCodeLine{00191\ GTEST\_API\_\ WithoutMatchers\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_without_matchers_a1876926d96532e975cd833abb3a137cb}{WithoutMatchers::Get}}()\ \{\ \textcolor{keywordflow}{return}\ WithoutMatchers();\ \}}
\DoxyCodeLine{00192\ }
\DoxyCodeLine{00193\ GTEST\_API\_\ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_aa67e1e9d28122eedffbb7b6636824f2d}{IllegalDoDefault}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ file,\ \textcolor{keywordtype}{int}\ line)\ \{}
\DoxyCodeLine{00194\ \ \ \doxymbox{\hyperlink{namespacetesting_1_1internal_aa46ca46a5898b2ac75184c62e0355621}{internal::Assert}}(}
...
\DoxyCodeLine{00201\ \}}
\DoxyCodeLine{00202\ }
\DoxyCodeLine{00203\ \textcolor{keyword}{constexpr}\ \textcolor{keywordtype}{char}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_acc8e0d2730dae1cf63d44e6ca4b00132}{UndoWebSafeEncoding}}(\textcolor{keywordtype}{char}\ c)\ \{}
...
\DoxyCodeLine{00211\ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ \doxymbox{\hyperlink{namespacetesting_1_1internal_adfca7fa821221defcd7dae3868372da2}{UnBase64Impl}}(c,\ base64\ +\ 1,\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{char}\textcolor{keyword}{>}(carry\ +\ 1));}
\DoxyCodeLine{00212\ \}}
\DoxyCodeLine{00213\ }
\DoxyCodeLine{00214\ \textcolor{keyword}{template}\ <\textcolor{keywordtype}{size\_t}...\ I>}
\DoxyCodeLine{00215\ \textcolor{keyword}{constexpr}\ std::array<char,\ 256>\ \doxymbox{\hyperlink{namespacetesting_1_1internal_adfca7fa821221defcd7dae3868372da2}{UnBase64Impl}}(std::index\_sequence<I...>,}
...
\DoxyCodeLine{00218\ \ \ \ \ \ \ \{\doxymbox{\hyperlink{namespacetesting_1_1internal_adfca7fa821221defcd7dae3868372da2}{UnBase64Impl}}(\doxymbox{\hyperlink{namespacetesting_1_1internal_acc8e0d2730dae1cf63d44e6ca4b00132}{UndoWebSafeEncoding}}(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{char}\textcolor{keyword}{>}(I)),\ base64,\ 0)...\}\};}
\DoxyCodeLine{00219\ \}}
\DoxyCodeLine{00220\ }
\DoxyCodeLine{00221\ \textcolor{keyword}{constexpr}\ std::array<char,\ 256>\ \doxymbox{\hyperlink{namespacetesting_1_1internal_aab5c01a6ea90354b06ae1a1838b115c2}{UnBase64}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keyword}{const}\ base64)\ \{}
\DoxyCodeLine{00222\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_adfca7fa821221defcd7dae3868372da2}{UnBase64Impl}}(std::make\_index\_sequence<256>\{\},\ base64);}
\DoxyCodeLine{00223\ \}}
\DoxyCodeLine{00224\ }
...
\DoxyCodeLine{00227\ \textcolor{keyword}{static}\ \textcolor{keyword}{constexpr}\ std::array<char,\ 256>\ kUnBase64\ =\ \doxymbox{\hyperlink{namespacetesting_1_1internal_aab5c01a6ea90354b06ae1a1838b115c2}{UnBase64}}(kBase64);}
\DoxyCodeLine{00228\ }
\DoxyCodeLine{00229\ \textcolor{keywordtype}{bool}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a7ebfee596839f25b8aec40192af1dcdc}{Base64Unescape}}(\textcolor{keyword}{const}\ std::string\&\ encoded,\ std::string*\ decoded)\ \{}
