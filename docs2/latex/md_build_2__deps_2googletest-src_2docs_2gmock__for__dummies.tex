\doxysection{g\+Mock for Dummies }
...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md203}{}\doxysubsection{\texorpdfstring{What Is g\+Mock?}{What Is g\+Mock?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md203}
...
\end{DoxyEnumerate}\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md204}{}\doxysubsection{\texorpdfstring{Why g\+Mock?}{Why g\+Mock?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md204}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md205}{}\doxysubsection{\texorpdfstring{Getting Started}{Getting Started}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md205}
g\+Mock is bundled with googletest.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md206}{}\doxysubsection{\texorpdfstring{A Case for Mock Turtles}{A Case for Mock Turtles}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md206}
...
You don\textquotesingle{}t need to define these mock methods somewhere else -\/ the {\ttfamily MOCK\+\_\+\+METHOD} macro will generate the definitions for you. It\textquotesingle{}s that simple!\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md209}{}\doxysubsubsection{\texorpdfstring{Where to Put It}{Where to Put It}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md209}
...
{\bfseries{Tip 2:\+}} If your mock objects are never deleted, the final verification won\textquotesingle{}t happen. Therefore it\textquotesingle{}s a good idea to turn on the heap checker in your tests when you allocate mocks on the heap. You get that automatically if you use the {\ttfamily gtest\+\_\+main} library already.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md211}{}\doxysubsubsubsubsubsection{\texorpdfstring{Expectation Ordering}{Expectation Ordering}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md211}
