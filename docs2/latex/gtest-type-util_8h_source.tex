\doxysubsection{gtest-\/type-\/util.h}
...
\DoxyCodeLine{00061\ \textcolor{keyword}{inline}\ std::string\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a5342e843f087081705094beae07b557b}{CanonicalizeForStdLibVersioning}}(std::string\ s)\ \{}
...
\DoxyCodeLine{00091\ \textcolor{keyword}{inline}\ std::string\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a635606b4731f843c86ec8ca51cab83a1}{GetTypeName}}(\textcolor{keyword}{const}\ std::type\_info\&\ type)\ \{}
...
\DoxyCodeLine{00103\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a5342e843f087081705094beae07b557b}{CanonicalizeForStdLibVersioning}}(name\_str);}
...
\DoxyCodeLine{00129\ std::string\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a635606b4731f843c86ec8ca51cab83a1}{GetTypeName}}()\ \{}
\DoxyCodeLine{00130\ \textcolor{preprocessor}{\#if\ GTEST\_HAS\_RTTI}}
\DoxyCodeLine{00131\ \ \ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a635606b4731f843c86ec8ca51cab83a1}{GetTypeName}}(\textcolor{keyword}{typeid}(T));}
...
\DoxyCodeLine{00138\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_none}{None}}\ \{\};}
\DoxyCodeLine{00139\ }
...
\DoxyCodeLine{00153\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_template_sel}{TemplateSel}}\ \{}
\DoxyCodeLine{00154\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00155\ \ \ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_template_sel_1_1_bind}{Bind}}\ \{}
\DoxyCodeLine{00156\ \ \ \ \ \textcolor{keyword}{typedef}\ Tmpl<T>\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_template_sel_1_1_bind_aa84b00f0c4cb97a60d7d8eb752d1956d}{type}};}
\DoxyCodeLine{00157\ \ \ \};}
\DoxyCodeLine{00158\ \};}
\DoxyCodeLine{00159\ }
...
\DoxyCodeLine{00163\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_templates}{Templates}}\ \{}
\DoxyCodeLine{00164\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_templates_afd2098f3ace72dca2bfb0b3657f7f937}{Head}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_template_sel}{TemplateSel<Head\_>}};}
\DoxyCodeLine{00165\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_templates_a462d57c3c1fc0a1bef26659dbd0c3b3d}{Tail}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_templates}{Templates}}<Tail\_...>;}
\DoxyCodeLine{00166\ \};}
\DoxyCodeLine{00167\ }
\DoxyCodeLine{00168\ \textcolor{keyword}{template}\ <GTEST\_TEMPLATE\_\ Head\_>}
\DoxyCodeLine{00169\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_templates}{Templates}}<Head\_>\ \{}
\DoxyCodeLine{00170\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_templates_3_01_head___01_4_ac6c76b1c4a4da401cc0e50c247cdd568}{Head}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_template_sel}{TemplateSel<Head\_>}};}
\DoxyCodeLine{00171\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_templates_3_01_head___01_4_a545ead14971baac1b876f7651c3529b9}{Tail}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_none}{None}};}
\DoxyCodeLine{00172\ \};}
\DoxyCodeLine{00173\ }
...
\DoxyCodeLine{00176\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_types}{Types}}\ \{}
\DoxyCodeLine{00177\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_types_af25c9ea6cd38071ce5154f3869fc0cc0}{Head}}\ =\ Head\_;}
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_types_a95f833deba9a29970bb310b80f97239f}{Tail}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_types}{Types}}<Tail\_...>;}
\DoxyCodeLine{00179\ \};}
\DoxyCodeLine{00180\ }
\DoxyCodeLine{00181\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Head\_>}
\DoxyCodeLine{00182\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_types}{Types}}<Head\_>\ \{}
\DoxyCodeLine{00183\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_types_3_01_head___01_4_acc643a692020fe60c80cf77fb984c04d}{Head}}\ =\ Head\_;}
\DoxyCodeLine{00184\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_types_3_01_head___01_4_a744a032ef03e4446a6943b68fd3f94ee}{Tail}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_none}{None}};}
\DoxyCodeLine{00185\ \};}
\DoxyCodeLine{00186\ }
...
\DoxyCodeLine{00190\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_proxy_type_list}{ProxyTypeList}}\ \{}
\DoxyCodeLine{00191\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_proxy_type_list_a7a70316d957e6c48becd3130490da997}{type}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_types}{Types}}<Ts...>;}
\DoxyCodeLine{00192\ \};}
\DoxyCodeLine{00193\ }
...
\DoxyCodeLine{00198\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1is__proxy__type__list}{is\_proxy\_type\_list}}<\doxymbox{\hyperlink{structtesting_1_1internal_1_1_proxy_type_list}{ProxyTypeList}}<Ts...>>\ :\ std::true\_type\ \{\};}
\DoxyCodeLine{00199\ }
...
\DoxyCodeLine{00204\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_generate_type_list}{GenerateTypeList}}\ \{}
...
\DoxyCodeLine{00207\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_proxy_type_list}{ProxyTypeList<T>}}>\doxymbox{\hyperlink{structtesting_1_1internal_1_1_generate_type_list_a576a76a145c45be743f9689146cf3fc5}{::type}};}
\DoxyCodeLine{00208\ }
\DoxyCodeLine{00209\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00210\ \ \ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_generate_type_list_a576a76a145c45be743f9689146cf3fc5}{type}}\ =\ \textcolor{keyword}{typename}\ proxy::type;}
\DoxyCodeLine{00211\ \};}
\DoxyCodeLine{00212\ }
...
\DoxyCodeLine{00216\ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{namespacetesting_a5e362473e2ee07d95ba239baf4436a71}{Types}}\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_proxy_type_list}{internal::ProxyTypeList}}<Ts...>;}
\DoxyCodeLine{00217\ }
