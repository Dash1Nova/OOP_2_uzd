...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md184}{}\doxysubsubsection{\texorpdfstring{When I call a method on my mock object, the method for the real object is invoked instead. What\textquotesingle{}s the problem?}{When I call a method on my mock object, the method for the real object is invoked instead. What\textquotesingle{}s the problem?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md184}
In order for a method to be mocked, it must be {\itshape virtual}, unless you use the \href{gmock_cook_book.md\#MockingNonVirtualMethods}{\texttt{high-\/perf dependency injection technique}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md185}{}\doxysubsubsection{\texorpdfstring{Can I mock a variadic function?}{Can I mock a variadic function?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md185}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md187}{}\doxysubsubsection{\texorpdfstring{I can\textquotesingle{}t figure out why g\+Mock thinks my expectations are not satisfied. What should I do?}{I can\textquotesingle{}t figure out why g\+Mock thinks my expectations are not satisfied. What should I do?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md187}
...
If you see the message "{}\+The mock function has no default action set, and its return type has no default value set."{}, then try \href{gmock_cheat_sheet.md\#OnCall}{\texttt{adding a default action}}. Due to a known issue, unexpected calls on mocks without default actions don\textquotesingle{}t print out a detailed comparison between the actual arguments and the expected arguments.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md188}{}\doxysubsubsection{\texorpdfstring{My program crashed and {\ttfamily Scoped\+Mock\+Log} spit out tons of messages. Is it a g\+Mock bug?}{My program crashed and {\ttfamily Scoped\+Mock\+Log} spit out tons of messages. Is it a g\+Mock bug?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md188}
...
\DoxyCodeLine{\ \ EXPECT\_CALL(log,\ \doxymbox{\hyperlink{namespacetesting_1_1internal_a8a57ce0412334a3f487bbaa8321febbe}{Log}}(\_,\ Not(\doxymbox{\hyperlink{namespacetesting_1_1internal_a4fe0a2f1ea296e6d92e6dcf8942818d6}{EndsWith}}(\textcolor{stringliteral}{"{}/my\_file.cc"{}})),\ \_))}
\DoxyCodeLine{\ \ \ \ \ \ .Times(AnyNumber());}

\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md189}{}\doxysubsubsection{\texorpdfstring{How can I assert that a function is NEVER called?}{How can I assert that a function is NEVER called?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md189}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md190}{}\doxysubsubsection{\texorpdfstring{I have a failed test where g\+Mock tells me TWICE that a particular expectation is not satisfied. Isn\textquotesingle{}t this redundant?}{I have a failed test where g\+Mock tells me TWICE that a particular expectation is not satisfied. Isn\textquotesingle{}t this redundant?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md190}
...
\DoxyCodeLine{\ \ EXPECT\_CALL(\doxymbox{\hyperlink{namespacefoo}{foo}},\ Bar())}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ ON\_CALL(\doxymbox{\hyperlink{namespacefoo}{foo}},\ Bar(\_))}
...
Also, you can control the verbosity by specifying {\ttfamily -\/-\/gmock\+\_\+verbose=error}. Other values are {\ttfamily info} and {\ttfamily warning}. If you find the output too noisy when debugging, just choose a less verbose level.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md194}{}\doxysubsubsection{\texorpdfstring{How can I delete the mock function\textquotesingle{}s argument in an action?}{How can I delete the mock function\textquotesingle{}s argument in an action?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md194}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md195}{}\doxysubsubsection{\texorpdfstring{How can I perform an arbitrary action on a mock function\textquotesingle{}s argument?}{How can I perform an arbitrary action on a mock function\textquotesingle{}s argument?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md195}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md196}{}\doxysubsubsection{\texorpdfstring{My code calls a static/\+global function. Can I mock it?}{My code calls a static/\+global function. Can I mock it?}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__faq_autotoc_md196}
