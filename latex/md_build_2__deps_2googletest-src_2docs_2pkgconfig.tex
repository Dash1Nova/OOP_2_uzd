...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/\+sample3\+\_\+unittest.\+cc}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md221}{}\doxysubsection{\texorpdfstring{CMake}{CMake}}\label{md_build_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md221}
