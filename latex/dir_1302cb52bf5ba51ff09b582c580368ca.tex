\doxysection{build\+\_\+test/\+\+\_\+deps/\+googletest-\/src/\+googletest Directory Reference}
\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca}{}\label{dir_1302cb52bf5ba51ff09b582c580368ca}\index{build\_test/\_deps/googletest-\/src/googletest Directory Reference@{build\_test/\_deps/googletest-\/src/googletest Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \doxymbox{\hyperlink{dir_6dd936ab237fabaf444d9e25e856edec}{docs}}
\item 
directory \doxymbox{\hyperlink{dir_39b4513bd3dc3a94e9d9082fb2e9cf61}{include}}
\item 
directory \doxymbox{\hyperlink{dir_7bdc2b89004f08d2dc730363516cd977}{samples}}
\item 
directory \doxymbox{\hyperlink{dir_4e4447a00b98f55f0873a9e8e5c8134d}{src}}
\item 
directory \doxymbox{\hyperlink{dir_f05030e8ebc83055819a4da285ec8409}{test}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md816}{}\doxysubsection{\texorpdfstring{Generic Build Instructions}{Generic Build Instructions}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md816}
\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md817}{}\doxysubsubsubsection{\texorpdfstring{Setup}{Setup}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md817}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md818}{}\doxysubsubsection{\texorpdfstring{Build with CMake}{Build with CMake}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md818}
...
CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md819}{}\doxysubsubsubsection{\texorpdfstring{Standalone CMake Project}{Standalone CMake Project}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md819}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md820}{}\doxysubsubsubsection{\texorpdfstring{Incorporating Into An Existing CMake Project}{Incorporating Into An Existing CMake Project}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md820}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md821}{}\doxysubsubsubsubsection{\texorpdfstring{Visual Studio Dynamic vs Static Runtimes}{Visual Studio Dynamic vs Static Runtimes}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md821}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md822}{}\doxysubsubsubsection{\texorpdfstring{C++ Standard Version}{C++ Standard Version}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md822}
An environment that supports C++17 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 17)} command along with {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD\+\_\+\+REQUIRED ON)}. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the{\ttfamily -\/DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md823}{}\doxysubsubsection{\texorpdfstring{Tweaking Google\+Test}{Tweaking Google\+Test}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md823}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{include/\+gtest/\+internal/\+gtest-\/port.\+h}}.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md824}{}\doxysubsubsection{\texorpdfstring{Multi-\/threaded Tests}{Multi-\/threaded Tests}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md824}
...
Note:\+ while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. GCC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{https://gcc.gnu.org/wiki/Visibility}{\texttt{https:\+/\+/\+gcc.\+gnu.\+org/\+wiki/\+\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google\+Test as a shared library. Otherwise a future release of Google\+Test may break your build script.\hypertarget{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md826}{}\doxysubsubsection{\texorpdfstring{Avoiding Macro Name Clashes}{Avoiding Macro Name Clashes}}\label{dir_1302cb52bf5ba51ff09b582c580368ca_autotoc_md826}
