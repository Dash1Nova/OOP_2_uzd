\doxysection{build\+\_\+wtests/\+\+\_\+deps/\+googletest-\/src/\+googletest Directory Reference}
\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661}{}\label{dir_9d86ed00898ca85f8a391baaafbd3661}\index{build\_wtests/\_deps/googletest-\/src/googletest Directory Reference@{build\_wtests/\_deps/googletest-\/src/googletest Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \doxymbox{\hyperlink{dir_8dc1cd77aaf3ebd9ed352e4891426631}{docs}}
\item 
directory \doxymbox{\hyperlink{dir_ae8d2e76b29d1f04bd38141bdae59718}{include}}
\item 
directory \doxymbox{\hyperlink{dir_394738a51ed92fd9c039fc7665b00e5e}{samples}}
\item 
directory \doxymbox{\hyperlink{dir_a3cb4f638b1b1f801a2400f36916fd99}{src}}
\item 
directory \doxymbox{\hyperlink{dir_b4e9afe1bdb9832a5ebdf06072c49058}{test}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1236}{}\doxysubsection{\texorpdfstring{Generic Build Instructions}{Generic Build Instructions}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1236}
\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1237}{}\doxysubsubsubsection{\texorpdfstring{Setup}{Setup}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1237}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1238}{}\doxysubsubsection{\texorpdfstring{Build with CMake}{Build with CMake}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1238}
...
CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1239}{}\doxysubsubsubsection{\texorpdfstring{Standalone CMake Project}{Standalone CMake Project}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1239}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1240}{}\doxysubsubsubsection{\texorpdfstring{Incorporating Into An Existing CMake Project}{Incorporating Into An Existing CMake Project}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1240}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1241}{}\doxysubsubsubsubsection{\texorpdfstring{Visual Studio Dynamic vs Static Runtimes}{Visual Studio Dynamic vs Static Runtimes}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1241}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1242}{}\doxysubsubsubsection{\texorpdfstring{C++ Standard Version}{C++ Standard Version}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1242}
An environment that supports C++17 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 17)} command along with {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD\+\_\+\+REQUIRED ON)}. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the{\ttfamily -\/DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1243}{}\doxysubsubsection{\texorpdfstring{Tweaking Google\+Test}{Tweaking Google\+Test}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1243}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{include/\+gtest/\+internal/\+gtest-\/port.\+h}}.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1244}{}\doxysubsubsection{\texorpdfstring{Multi-\/threaded Tests}{Multi-\/threaded Tests}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1244}
...
Note:\+ while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. GCC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{https://gcc.gnu.org/wiki/Visibility}{\texttt{https:\+/\+/\+gcc.\+gnu.\+org/\+wiki/\+\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google\+Test as a shared library. Otherwise a future release of Google\+Test may break your build script.\hypertarget{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1246}{}\doxysubsubsection{\texorpdfstring{Avoiding Macro Name Clashes}{Avoiding Macro Name Clashes}}\label{dir_9d86ed00898ca85f8a391baaafbd3661_autotoc_md1246}
...
to the compiler flags to tell Google\+Test to change the macro\textquotesingle{}s name from {\ttfamily FOO} to {\ttfamily GTEST\+\_\+\+FOO}. Currently {\ttfamily FOO} can be {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_a1a6db8b1338ee7040329322b77779086}{ASSERT\+\_\+\+EQ}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_a8197fa52f3538588d20d8af4834c9003}{ASSERT\+\_\+\+FALSE}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_af4ff5dc71479fcb374b6bc2ed195bcc4}{ASSERT\+\_\+\+GE}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_a16a882d4eafc9f8643867aea40879140}{ASSERT\+\_\+\+GT}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_a775643748feff0b490aae651d041e971}{ASSERT\+\_\+\+LE}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_affc4f9cae4c3aabfe60fced83737b42c}{ASSERT\+\_\+\+LT}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_aa866c8dece57912e6f51495ed3e8d8d5}{ASSERT\+\_\+\+NE}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_ae9244bfbda562e8b798789b001993fa5}{ASSERT\+\_\+\+TRUE}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_aeb6c7ae89f440c90c1a1815951c836da}{EXPECT\+\_\+\+FALSE}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_ac33e7cdfb5d44a7a0f0ab552eb5c3c6a}{EXPECT\+\_\+\+TRUE}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_a3e26a8d27caa386ed0ea7ce9d5b7c4ed}{FAIL}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_a75adcdf89f69b0b615e395daafc315af}{SUCCEED}}, {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST}}, or {\ttfamily \doxylink{__deps_2googletest-src_2googletest_2include_2gtest_2gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+F}}. For example, with {\ttfamily -\/DGTEST\+\_\+\+DONT\+\_\+\+DEFINE\+\_\+\+TEST=1}, you\textquotesingle{}ll need to write
