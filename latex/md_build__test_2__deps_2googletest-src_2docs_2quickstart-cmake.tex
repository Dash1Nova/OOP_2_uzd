...
\hypertarget{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake}{}\label{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake}\index{Quickstart: Building with CMake@{Quickstart: Building with CMake}}
\label{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md659}%
\Hypertarget{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md659}%


This tutorial aims to get you up and running with Google\+Test using CMake. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the \doxysectlink{md_build__test_2__deps_2googletest-src_2docs_2quickstart-bazel}{Quickstart for Bazel}{0} instead.\hypertarget{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md660}{}\doxysection{\texorpdfstring{Prerequisites}{Prerequisites}}\label{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md660}
...
\{:\+ .callout .note\} Note:\+ The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md661}{}\doxysection{\texorpdfstring{Set up a project}{Set up a project}}\label{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md661}
...
For more information about how to create {\ttfamily CMake\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{CMake Tutorial}}.\hypertarget{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md662}{}\doxysection{\texorpdfstring{Create and run a binary}{Create and run a binary}}\label{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md662}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md663}{}\doxysection{\texorpdfstring{Next steps}{Next steps}}\label{md_build__test_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md663}
